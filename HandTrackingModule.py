...
class HandDetector():
    ...
    def getDistance(self, p1, p2, frame=None, color=(255, 0, 255), scale=10):
        x1, y1, z1 = p1
        x2, y2, z2 = p2
        ...
        if frame is not None:
            cv.circle(frame, (x1, y1), scale, color, -1)
            cv.circle(frame, (x2, y2), scale, color, -1)
            cv.line(frame, (x1, y1), (x2, y2), color, max(1, scale // 3))
            cv.circle(frame, (cx, cy), scale, color, -1)
